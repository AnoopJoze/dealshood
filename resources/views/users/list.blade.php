...
@push('css')
    ...
    <style>
        ...
        /* Dot indicator for tab with error */
        .modal-tab-nav .nav-link .tab-err-dot {
                        ...
                        <table id="datatable" class="table align-middle table-hover mb-0">
                            <thead class="bg-light">
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs fw-bolder text-center" style="width:80px">Action</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
            ...
            <div class="modal-body px-4 py-3">
                ...
                <div class="modal-tab-pane" id="tab-account">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold text-sm mb-1">WhatsApp Number</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="form-label fw-semibold text-sm mb-1">About Me</label>
                ...
                <div class="modal-tab-pane d-none" id="tab-address">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold text-sm mb-1">Location / City</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light border-end-0">
...
$(function () {
    ...
    */
    ...
    // Map each field to its tab so we can highlight the right tab on error
    var fieldTabMap = {
        name                : 'tab-account',
        email               : 'tab-account',
        password            : 'tab-account',
        role                : 'tab-account',
        status              : 'tab-account',
        phone               : 'tab-account',
        whatsapp_number     : 'tab-account',
        about_me            : 'tab-account',
        company_name        : 'tab-business',
        website             : 'tab-business',
        location            : 'tab-address',
        address             : 'tab-address',
        latitude            : 'tab-address',
        longitude           : 'tab-address',
    };

    function clearErrors() {
        $('.text-danger[id^="err_"]').addClass('d-none').text('');
        $('.form-control, .form-select').removeClass('is-invalid');
        // Remove error dots from tabs
    ...
    function showErrors(errors) {
        ...
        // Add red dot to each tab with errors
    ...
    */
    ...
    function setEditMode(user) {
        ...
        $('#modalAvatarLetter').removeClass('d-none').text(letter);
